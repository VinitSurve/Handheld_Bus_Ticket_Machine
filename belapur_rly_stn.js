...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('swapLocationsButton').addEventListener('click', function() {
        ...
        if (heading.textContent === 'Belapur Rly.Stn To Panvel Rly.Stn') {
            heading.textContent = 'Panvel Rly.Stn To Belapur Rly.Stn';
        } else {
            heading.textContent = 'Belapur Rly.Stn To Panvel Rly.Stn';
        }
    });
