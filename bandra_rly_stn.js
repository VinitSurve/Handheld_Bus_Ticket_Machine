...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('swapLocationsButton').addEventListener('click', function() {
        ...
        if (heading.textContent === 'Bandra Rly.Stn To Panvel Rly.Stn') {
            heading.textContent = 'Panvel Rly.Stn To Bandra Rly.Stn';
        } else {
            heading.textContent = 'Bandra Rly.Stn To Panvel Rly.Stn';
        }
    });
