...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('swapLocationsButton').addEventListener('click', function() {
        ...
        if (heading.textContent === 'Ghansoli Depot To Panvel Rly.Stn') {
            heading.textContent = 'Panvel Rly.Stn To Ghansoli Depot';
        } else {
            heading.textContent = 'Ghansoli Depot To Panvel Rly.Stn';
        }
    });
