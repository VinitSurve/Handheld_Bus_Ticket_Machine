...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('swapLocationsButton').addEventListener('click', function() {
        ...
        if (heading.textContent === 'Vashi Bus Station To Panvel Rly.Stn') {
            heading.textContent = 'Panvel Rly.Stn To Vashi Bus Station ';
        } else {
            heading.textContent = 'Vashi Bus Station To Panvel Rly.Stn';
        }
    });
