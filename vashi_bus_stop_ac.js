document.addEventListener("DOMContentLoaded", function() {
    ...
    "C.B.D. Belapur Highway / Konkan Bhavan": 17,
    "Uran Phata": 18,
    "Tata Press": 19,
    "D.Y.Patil Stadium": 20,
    "Nerul Naka": 21,
    "Shiravane Village": 22,
    "Juinagar Station (Herdilla Co.)": 23,
    "Sanpada Police Station": 24,
    "Turbhe Naka (Janta Market)": 25,
    "I.C.L.School (Vashi)": 26,
    "A.P.M.C.Market (Vashi)": 27,
    "Kanda Batata Market": 28,
    "Saint Lawrence High School (Vashi)": 29,
    "Vashi Bus Station": 30
};
        ...
        setTimeout(resetButton, 3500); // Reset button after 4 seconds
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('swapLocationsButton').addEventListener('click', function() {
        ...
        if (heading.textContent === 'Vashi Bus Station To Panvel Rly.Stn (AC)') {
            heading.textContent = 'Panvel Rly.Stn To Vashi Bus Station (AC)';
        } else {
            heading.textContent = 'Vashi Bus Station To Panvel Rly.Stn (AC)';
        }
    });
