...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('swapLocationsButton').addEventListener('click', function() {
        ...
        if (heading.textContent === 'Kharghar Rly.Stn To Panvel Rly.Stn') {
            heading.textContent = 'Panvel Rly.Stn To Kharghar Rly.Stn';
        } else {
            heading.textContent = 'Kharghar Rly.Stn To Panvel Rly.Stn';
        }
    });
